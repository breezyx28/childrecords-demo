...
const ReminderToolbar: React.FC<ReminderToolbarProps> = ({
  searchQuery,
  setSearchQuery,
  selectedDateFilter,
 ...
 * 
 * 
 *  <div className="w-full flex justify-between gap-x-[12px] mt-[0.75rem]">
               <div className="md:min-w-[200px] min-w-[0px] w-full flex items-center gap-x-[8px] outline-none rounded-[8px] border p-[10px]">
                 <SearchIcon size={16} />
                 <input
                   type="text"
               ...
               <SelectMenu
                 ...
                 customTrigger={<div>Filter By Date</div>}
                 className="!md:max-w-[160px] !max-w-auto p-[14px] h-full w-full"
               />
               <Button
                 text="Add"
