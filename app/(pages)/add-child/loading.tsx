...
const AddChildLoading = () => {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center md:px-[0px] px-[20px]">
      <div className="wrapper flex flex-col items-center gap-y-[28px] max-w-[440px]">
        ...
        <p className="w-full text-center text-[26px] font-[800] leading-[38.19px]">
          Hold on a bet, we are preparing your child informations...
        </p>
      </div>
    </div>
  );
...
export default AddChildLoading;
